# Form implementation generated from reading ui file 'ankimorphs/readability_settings.ui'
#
...
class Ui_ReadabilitySettingsDialog(object):
    def setupUi(self, ReadabilitySettingsDialog):
        ...
        self.alwaysMeetReadTargettCheckBox.setObjectName(
            "alwaysMeetReadTargettCheckBox"
        )
        self.verticalLayout.addWidget(self.alwaysMeetReadTargettCheckBox)
        self.resetLearnedAfterEachInputCheckBox = QtWidgets.QCheckBox(
            self.studyPlanGroup
        )
        self.resetLearnedAfterEachInputCheckBox.setObjectName(
            "resetLearnedAfterEachInputCheckBox"
        )
        ...
        sizePolicy.setHeightForWidth(
            self.optimalMasterTargetSpinBox.sizePolicy().hasHeightForWidth()
        )
        ...
        self.optimalMasterTargetSpinBox.setAlignment(
        ...
        self.saveSeparateWordReportsCheckBox.setObjectName(
            "saveSeparateWordReportsCheckBox"
        )
    ...
    def retranslateUi(self, ReadabilitySettingsDialog):
        ...
        ReadabilitySettingsDialog.setWindowTitle(
            _translate("ReadabilitySettingsDialog", "Advanced Settings")
        )
        self.studyPlanGroup.setTitle(
            _translate("ReadabilitySettingsDialog", "Study Plan")
        )
        self.alwaysAddMinimumFreqCheckBox.setToolTip(
            _translate(
                "ReadabilitySettingsDialog",
                "Always add Minimum Frequency morphs to the study plan,\n"
                "even if it exceeds the readability 'Target %'.",
            )
        )
        self.alwaysAddMinimumFreqCheckBox.setText(
            _translate(
                "ReadabilitySettingsDialog", "Always add Minimum Frequency morphs"
            )
        )
        self.alwaysMeetReadTargettCheckBox.setToolTip(
            _translate(
                "ReadabilitySettingsDialog",
                "Always add enough morphs to the Study Plan to meet the readability 'Target %'\n"
                "even if morphemes are below the 'Minimum Frequency'.\n"
                "\n"
                "'Minimum Frequency' morphs still take priority.",
            )
        )
        self.alwaysMeetReadTargettCheckBox.setText(
            _translate("ReadabilitySettingsDialog", "Always meet Target %")
        )
        self.resetLearnedAfterEachInputCheckBox.setToolTip(
            _translate(
                "ReadabilitySettingsDialog",
                "Default study plans assume you learn the words in each input before moving on to the next.\n"
                "This option clears that learning.\n"
                "\n"
                "Using this option is useful for analysis rather than for use as an acutal study plan.",
            )
        )
        self.resetLearnedAfterEachInputCheckBox.setText(
            _translate(
                "ReadabilitySettingsDialog", "Reset learned morphs after each input"
            )
        )
        self.optimalMasterTargetLabel.setText(
            _translate(
                "ReadabilitySettingsDialog",
                "Generate optimal order to Master Readability:",
            )
        )
        self.optimalMasterTargetSpinBox.setSuffix(
            _translate("ReadabilitySettingsDialog", "%")
        )
        self.frequencyListGroup.setTitle(
            _translate("ReadabilitySettingsDialog", "Frequency Lists")
        )
        self.fillAllMorphsCheckBox.setToolTip(
            _translate(
                "ReadabilitySettingsDialog",
        ...
        self.fillAllMorphsCheckBox.setText(
            _translate(
                "ReadabilitySettingsDialog",
                "Add all missing morphemes at the end of the Frequency List",
            )
        )
        self.wordReportGroup.setTitle(
            _translate("ReadabilitySettingsDialog", "Word Reports")
        )
        self.saveMissingWordsCheckBox.setToolTip(
            _translate(
                "ReadabilitySettingsDialog",
                "Save a report including any unknown morphs in the Master Frequency List.\n"
                "\n"
                "Outputs:\n"
                " - missing_master_word_report.txt",
            )
        )
        self.saveMissingWordsCheckBox.setText(
            _translate("ReadabilitySettingsDialog", "Save Missing Words Report")
        )
        self.saveSeparateWordReportsCheckBox.setToolTip(
            _translate(
                "ReadabilitySettingsDialog",
                "Output a word report for each input.\n"
                "\n"
                "Outputs:\n"
                " - a 'word_reports' directory with a word report per input source.",
            )
        )
        self.saveSeparateWordReportsCheckBox.setText(
            _translate("ReadabilitySettingsDialog", "Save a Word Report for each input")
        )
        self.saveReadabilityDBCheckBox.setToolTip(
            _translate(
                "ReadabilitySettingsDialog",
                "Generare a readability corpus database.\n"
                "\n"
                "Outputs:\n"
                " - word_corpus.corpusdb",
            )
        )
        self.saveReadabilityDBCheckBox.setText(
            _translate("ReadabilitySettingsDialog", "Save Readability Corpus DB")
        )
        self.extrasGroup.setTitle(_translate("ReadabilitySettingsDialog", "Extras"))
        self.migakuDictionaryTagsCheckBox.setToolTip(
            _translate(
                "ReadabilitySettingsDialog",
                "Add MorphMan frequency tags to Migaku Dictionary entries.\n"
                "Requires Migaku Dictionary to be installed.",
            )
        )
        self.migakuDictionaryTagsCheckBox.setText(
            _translate("ReadabilitySettingsDialog", "Migaku Dictionary Tags")
        )
        self.webServiceCheckBox.setToolTip(
            _translate(
                "ReadabilitySettingsDialog",
                "Enables a WebSocket Service, allowing external apps to use MorphMan services.\n"
                "Requires re-opening the Readability Analyzer to take effect.",
            )
        )
        self.webServiceCheckBox.setText(
            _translate("ReadabilitySettingsDialog", "Enable Web Service (beta)")
        )
