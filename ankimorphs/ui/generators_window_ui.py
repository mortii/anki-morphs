...
class Ui_GeneratorsWindow(object):
    def setupUi(self, GeneratorsWindow):
        ...
        self.customCharactersCheckBox = QtWidgets.QCheckBox(parent=self.centralwidget)
        ...
        self.customCharactersLineEdit = QtWidgets.QLineEdit(parent=self.centralwidget)
        ...
        self.verticalLayout_5.addWidget(self.tablesTabWidget)
