...
class Ui_ProgressWindow(object):
    def setupUi(self, ProgressWindow):
        ...
        self.numericalTableWidget.setColumnCount(3)
    ...
    def retranslateUi(self, ProgressWindow):
        ...
        self.calculateProgressPushButton.setText(_translate("ProgressWindow", "Calculate Progress"))
