...
class Ui_ReadabilityReportGeneratorWindow(object):
    def setupUi(self, ReadabilityReportGeneratorWindow):
        ...
        ReadabilityReportGeneratorWindow.resize(680, 600)
        ...
        self.menubar = QtWidgets.QMenuBar(parent=ReadabilityReportGeneratorWindow)
        self.menubar.setGeometry(QtCore.QRect(0, 0, 680, 22))
        self.menubar.setObjectName("menubar")
        ReadabilityReportGeneratorWindow.setMenuBar(self.menubar)
        self.statusbar = QtWidgets.QStatusBar(parent=ReadabilityReportGeneratorWindow)
        self.statusbar.setObjectName("statusbar")
        ReadabilityReportGeneratorWindow.setStatusBar(self.statusbar)
...
"Report"))
        ...
        item.setText(_translate("ReadabilityReportGeneratorWindow", "Total Morphs"))
        item = self.numericalTableWidget.horizontalHeaderItem(2)
        item.setText(_translate("ReadabilityReportGeneratorWindow", "Known"))
        item = self.numericalTableWidget.horizontalHeaderItem(3)
        item.setText(_translate("ReadabilityReportGeneratorWindow", "Learning"))
        item = self.numericalTableWidget.horizontalHeaderItem(4)
        item.setText(_translate("ReadabilityReportGeneratorWindow", "Unknown"))
        item = self.numericalTableWidget.horizontalHeaderItem(5)
        item.setText(_translate("ReadabilityReportGeneratorWindow", "Total Instances"))
        item = self.numericalTableWidget.horizontalHeaderItem(6)
        item.setText(_translate("ReadabilityReportGeneratorWindow", "Known Instances"))
        item = self.numericalTableWidget.horizontalHeaderItem(7)
        item.setText(_translate("ReadabilityReportGeneratorWindow", "Learning Instances"))
        item = self.numericalTableWidget.horizontalHeaderItem(8)
        item.setText(_translate("ReadabilityReportGeneratorWindow", "Unknown Instances"))
