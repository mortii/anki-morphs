...
class Ui_ProgressionWindow(object):
    def setupUi(self, ProgressionWindow):
        ...
        ProgressionWindow.resize(758, 539)
        ...
        self.horizontalLayout_3.addWidget(self.binSizeSpinBox)
        ...
        self.normalRadioButton = QtWidgets.QRadioButton(parent=self.centralwidget)
        ...
        self.cumulativeRadioButton = QtWidgets.QRadioButton(parent=self.centralwidget)
        ...
        self.calculateProgressPushButton.setMinimumSize(QtCore.QSize(0, 0))
        self.calculateProgressPushButton.setMaximumSize(QtCore.QSize(150, 16777215))
        self.calculateProgressPushButton.setObjectName("calculateProgressPushButton")
        self.horizontalLayout_4.addWidget(self.calculateProgressPushButton)
    ...
    def retranslateUi(self, ProgressionWindow):
        ...
        self.label_5.setText(_translate("ProgressionWindow", " with bin size:"))
        ...
        self.calculateProgressPushButton.setText(_translate("ProgressionWindow", "Create\n"
"Progress\n"
"Report"))
