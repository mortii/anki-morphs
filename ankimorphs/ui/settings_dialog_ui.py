...
class Ui_SettingsDialog:
    def setupUi(self, SettingsDialog):
        ...
        self.parseIgnoreSquareCheckBox = QtWidgets.QCheckBox(parent=self.parse_tab)
        self.parseIgnoreSquareCheckBox.setObjectName("parseIgnoreSquareCheckBox")
        self.verticalLayout_9.addWidget(self.parseIgnoreSquareCheckBox)
        self.parseIgnoreRoundCheckBox = QtWidgets.QCheckBox(parent=self.parse_tab)
        self.parseIgnoreRoundCheckBox.setObjectName("parseIgnoreRoundCheckBox")
        self.verticalLayout_9.addWidget(self.parseIgnoreRoundCheckBox)
        self.parseIgnoreSlimCheckBox = QtWidgets.QCheckBox(parent=self.parse_tab)
        self.parseIgnoreSlimCheckBox.setObjectName("parseIgnoreSlimCheckBox")
        self.verticalLayout_9.addWidget(self.parseIgnoreSlimCheckBox)
        self.parseIgnoreSuspendedCheckBox = QtWidgets.QCheckBox(parent=self.parse_tab)
        self.parseIgnoreSuspendedCheckBox.setObjectName("parseIgnoreSuspendedCheckBox")
        self.verticalLayout_9.addWidget(self.parseIgnoreSuspendedCheckBox)
        self.parseIgnoreNamesMizerCheckBox = QtWidgets.QCheckBox(parent=self.parse_tab)
        self.parseIgnoreNamesMizerCheckBox.setObjectName("parseIgnoreNamesMizerCheckBox")
        self.verticalLayout_9.addWidget(self.parseIgnoreNamesMizerCheckBox)
        self.parseIgnoreNamesFileCheckBox = QtWidgets.QCheckBox(parent=self.parse_tab)
        self.parseIgnoreNamesFileCheckBox.setObjectName("parseIgnoreNamesFileCheckBox")
        self.verticalLayout_9.addWidget(self.parseIgnoreNamesFileCheckBox)
        ...
        self.restoreParsePushButton = QtWidgets.QPushButton(parent=self.parse_tab)
        self.restoreParsePushButton.setObjectName("restoreParsePushButton")
        self.horizontalLayout_8.addWidget(self.restoreParsePushButton)
    ...
    def retranslateUi(self, SettingsDialog):
        ...
        self.parseIgnoreSquareCheckBox.setText(_translate("SettingsDialog", "ignore content in square brackets []"))
        self.parseIgnoreRoundCheckBox.setText(_translate("SettingsDialog", "ignore content in round brackets（）"))
        self.parseIgnoreSlimCheckBox.setText(_translate("SettingsDialog", "ignore content in slim round brackets ()"))
        self.parseIgnoreSuspendedCheckBox.setText(_translate("SettingsDialog", "Ignore content in suspended cards"))
        self.parseIgnoreNamesMizerCheckBox.setText(_translate("SettingsDialog", "Ignore names found by the morphemizer"))
        self.parseIgnoreNamesFileCheckBox.setText(_translate("SettingsDialog", "Ignore names found in names.txt"))
        self.restoreParsePushButton.setText(_translate("SettingsDialog", "Restore Default Parse Settings"))
