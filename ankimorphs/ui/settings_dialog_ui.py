...
class Ui_SettingsDialog(object):
    def setupUi(self, SettingsDialog):
        ...
        self.verticalLayout_26.setContentsMargins(-1, -1, -1, 10)
        ...
        self.spinBox_9 = QtWidgets.QSpinBox(parent=self.tab)
        ...
        self.verticalLayout_27.setContentsMargins(-1, -1, -1, 15)
        ...
        self.spinBox_18 = QtWidgets.QSpinBox(parent=self.tab)
        self.spinBox_18.setObjectName("spinBox_18")
        self.horizontalLayout_18.addWidget(self.spinBox_18)
        self.label_31 = QtWidgets.QLabel(parent=self.tab)
        self.label_31.setObjectName("label_31")
        self.horizontalLayout_18.addWidget(self.label_31)
        self.spinBox_19 = QtWidgets.QSpinBox(parent=self.tab)
        self.spinBox_19.setObjectName("spinBox_19")
        self.horizontalLayout_18.addWidget(self.spinBox_19)
        self.spinBox_20 = QtWidgets.QSpinBox(parent=self.tab)
        self.spinBox_20.setObjectName("spinBox_20")
        self.horizontalLayout_18.addWidget(self.spinBox_20)
        self.spinBox_21 = QtWidgets.QSpinBox(parent=self.tab)
        self.spinBox_21.setObjectName("spinBox_21")
        self.horizontalLayout_18.addWidget(self.spinBox_21)
        ...
        self.spinBox_22 = QtWidgets.QSpinBox(parent=self.tab)
        self.spinBox_22.setObjectName("spinBox_22")
        self.horizontalLayout_19.addWidget(self.spinBox_22)
        self.spinBox_23 = QtWidgets.QSpinBox(parent=self.tab)
        self.spinBox_23.setObjectName("spinBox_23")
        self.horizontalLayout_19.addWidget(self.spinBox_23)
        self.spinBox_24 = QtWidgets.QSpinBox(parent=self.tab)
        self.spinBox_24.setObjectName("spinBox_24")
        self.horizontalLayout_19.addWidget(self.spinBox_24)
        ...
        self.spinBox_10 = QtWidgets.QSpinBox(parent=self.tab)
        self.spinBox_10.setObjectName("spinBox_10")
        self.verticalLayout_29.addWidget(self.spinBox_10)
        self.spinBox_11 = QtWidgets.QSpinBox(parent=self.tab)
        self.spinBox_11.setObjectName("spinBox_11")
        self.verticalLayout_29.addWidget(self.spinBox_11)
        self.spinBox_12 = QtWidgets.QSpinBox(parent=self.tab)
        self.spinBox_12.setObjectName("spinBox_12")
        self.verticalLayout_29.addWidget(self.spinBox_12)
        self.spinBox_13 = QtWidgets.QSpinBox(parent=self.tab)
        self.spinBox_13.setObjectName("spinBox_13")
        self.verticalLayout_29.addWidget(self.spinBox_13)
        self.spinBox_14 = QtWidgets.QSpinBox(parent=self.tab)
        self.spinBox_14.setObjectName("spinBox_14")
        self.verticalLayout_29.addWidget(self.spinBox_14)
        ...
        spacerItem17 = QtWidgets.QSpacerItem(17, 37, QtWidgets.QSizePolicy.Policy.Minimum, QtWidgets.QSizePolicy.Policy.Expanding)
    ...
    def retranslateUi(self, SettingsDialog):
        ...
        self.label_26.setText(_translate("SettingsDialog", "Total priority unknown morphs"))
        self.label_27.setText(_translate("SettingsDialog", "Average priority all morphs"))
        ...
        self.label_34.setText(_translate("SettingsDialog", "Learning morphs target distance"))
        self.pushButton.setText(_translate("SettingsDialog", "Restore Default Algorithm Settings"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab), _translate("SettingsDialog", "Algorithm"))
