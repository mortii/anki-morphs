...
class Ui_SettingsDialog:
    def setupUi(self, SettingsDialog):
        ...
        self.label_15 = QtWidgets.QLabel(parent=self.tags_tab)
        self.label_15.setObjectName("label_15")
        self.verticalLayout_8.addWidget(self.label_15)
        self.label = QtWidgets.QLabel(parent=self.tags_tab)
        self.label.setObjectName("label")
        self.verticalLayout_8.addWidget(self.label)
        self.label_7 = QtWidgets.QLabel(parent=self.tags_tab)
        ...
        self.spinBox = QtWidgets.QSpinBox(parent=self.tags_tab)
        ...
        self.learning_tag_input = QtWidgets.QLineEdit(parent=self.tags_tab)
        self.learning_tag_input.setObjectName("learning_tag_input")
        self.verticalLayout_7.addWidget(self.learning_tag_input)
        self.modify_tag_input = QtWidgets.QLineEdit(parent=self.tags_tab)
        self.modify_tag_input.setObjectName("modify_tag_input")
        self.verticalLayout_7.addWidget(self.modify_tag_input)
    ...
    def retranslateUi(self, SettingsDialog):
        ...
        self.label_15.setText(_translate("SettingsDialog", "Min. interval for known morphs"))
        self.label.setText(_translate("SettingsDialog", "Morph seen but not yet known"))
        self.label_7.setText(_translate("SettingsDialog", "Modify enabled"))
        self.label_6.setText(_translate("SettingsDialog", "days"))
