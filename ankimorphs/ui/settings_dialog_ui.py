...
class Ui_SettingsDialog:
    def setupUi(self, SettingsDialog):
        ...
        self.extra_fields_table.setColumnCount(5)
        ...
        item = QtWidgets.QTableWidgetItem()
        self.extra_fields_table.setHorizontalHeaderItem(4, item)
...
" - Create a backup of your card collection."))
        ...
        item.setText(_translate("SettingsDialog", "Unknowns Count"))
        item = self.extra_fields_table.horizontalHeaderItem(3)
        item.setText(_translate("SettingsDialog", "Highlighted"))
        item = self.extra_fields_table.horizontalHeaderItem(4)
