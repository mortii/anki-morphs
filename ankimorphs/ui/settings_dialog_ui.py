...
class Ui_SettingsDialog:
    def setupUi(self, SettingsDialog):
        ...
        self.learn_card_now_tag_input = QtWidgets.QLineEdit(parent=self.tags_tab)
        self.learn_card_now_tag_input.setObjectName("learn_card_now_tag_input")
        self.verticalLayout_7.addWidget(self.learn_card_now_tag_input)
        self.known_manually_tag_input = QtWidgets.QLineEdit(parent=self.tags_tab)
        self.known_manually_tag_input.setObjectName("known_manually_tag_input")
        self.verticalLayout_7.addWidget(self.known_manually_tag_input)
        self.known_automatically_tag_input = QtWidgets.QLineEdit(parent=self.tags_tab)
        self.known_automatically_tag_input.setObjectName("known_automatically_tag_input")
        self.verticalLayout_7.addWidget(self.known_automatically_tag_input)
        ...
        self.recalc_suspend_new_cards_input = QtWidgets.QCheckBox(parent=self.recalc_tab)
        self.recalc_suspend_new_cards_input.setObjectName("recalc_suspend_new_cards_input")
        self.verticalLayout_21.addWidget(self.recalc_suspend_new_cards_input)
...
" - Create a backup of your card collection."))
        ...
        self.recalc_on_sync_input.setText(_translate("SettingsDialog", "Automatically Recalc before Anki sync"))
        self.recalc_suspend_new_cards_input.setText(_translate("SettingsDialog", "Suspend new cards with only known morphs"))
