...
class FakeConfig:
    def __init__(self):
        self.default = {
            ...
            "path_mature": os.path.join(
                os.getcwd(), "tests", "data", "dbs", "mature.db"
            ),
            "path_frequency": os.path.join(
                os.getcwd(), "tests", "data", "dbs", "data/frequency.txt"
            ),
            "path_stats": os.path.join(
                os.getcwd(), "tests", "data", "dbs", "morphman.stats"
            ),
            "threshold_mature": 21,  # 21 days is what Anki uses
            "threshold_known": 10 / 86400.0,
            "threshold_seen": 1 / 86400.0,
